...
if __name__ == "__main__":
    ...
    # FIXED Strategy
    for start_t in tqdm(range(0, time_intervals - BATCH_SIZE, OVERLAP_SAVE_SIZE), desc="FIXED Optimization Progress", unit="batch"):
    ...
    # DYNAMIC Strategy
    for start_t in tqdm(range(0, time_intervals - BATCH_SIZE, OVERLAP_SAVE_SIZE), desc="DYNAMIC Optimization Progress", unit="batch"):
    ...
    print(f"✅ FIXED Strategy Success: {100 * (1 - len(failed_batches_fixed) / ((time_intervals - BATCH_SIZE) / OVERLAP_SAVE_SIZE)):.2f}%")

    print(f"❌ DYNAMIC Strategy Failures: {len(failed_batches_dynamic)} batches failed.")
    print(f"✅ DYNAMIC Strategy Success: {100 * (1 - len(failed_batches_dynamic) / ((time_intervals - BATCH_SIZE) / OVERLAP_SAVE_SIZE)):.2f}%")
    ...
    # =======================
    version = "v11"  # Update version as needed
