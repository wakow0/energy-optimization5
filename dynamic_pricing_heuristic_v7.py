...
SOC_EXPORT_THRESHOLD = 0.5 * BATTERY_CAPACITY
SOC_DISCHARGE_THRESHOLD = 0.1 * BATTERY_CAPACITY
...
for i in range(len(df)):
    ...
    # Step 2: Charge from surplus renewable
    ...
    # Step 3: Export remaining if SoC > threshold
...
df[output_cols].to_csv("dynamic_pricing_v7_solution.csv", index=False)
print("✅ Saved dynamic_pricing_v7_solution.csv")
