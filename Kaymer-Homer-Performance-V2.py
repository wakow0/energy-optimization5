...
# ✅ Load the CSV files
opt_results_fixed = pd.read_csv("WorkingCodeVersion1_FIXED_v10_4.csv")
opt_results_dynamic = pd.read_csv("WorkingCodeVersion1_DYNAMIC_v10_4.csv")
opt_results_homer = pd.read_csv("WorkingCodeVersion1_HOMER_v10_4.csv")
