...
for i in tqdm(range(0, time_intervals, BATCH_SIZE), desc="FIXED Optimization Progress", unit="batch"):
    batch_results, prev_final_soc_fixed, prev_batch_powers_fixed = optimize_energy(
        i, "FIXED", prev_final_soc_fixed, prev_batch_powers_fixed)
...
for i in tqdm(range(0, time_intervals, BATCH_SIZE), desc="DYNAMIC Optimization Progress", unit="batch"):
    batch_results, prev_final_soc_dynamic, prev_batch_powers_dynamic = optimize_energy(
        i, "DYNAMIC", prev_final_soc_dynamic, prev_batch_powers_dynamic)
...
if __name__ == "__main__":
    ...
    # =======================
    version = "v8"  # Update version as needed
