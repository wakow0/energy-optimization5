...
EXPORT_PRICE_THRESHOLD = 0.08  # lowered threshold
FORCE_DISCHARGE_SOC_THRESHOLD = 0.2 * BATTERY_CAPACITY  # force discharge above 20% SoC
...
for i in range(len(df)):
    ...
    # Force battery discharge if SoC > 20% and import price is high
    ...
    # Export excess if export price is decent
...
output_df.to_csv("dynamic_pricing_v2_solution.csv", index=False)
print("✅ Dynamic pricing v2 solution saved to 'dynamic_pricing_v2_solution.csv'")
